...
#define xQueuePop( xQueue, pvBuffer, xTicksToWait ) xQueueGenericReceive( ( xQueue ), ( pvBuffer ), ( xTicksToWait ), pdFALSE ) // original pdTRUE-- changed so the peek becomes a pop
